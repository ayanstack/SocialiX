          ...
          {!isAuthPage && currentUser ? (
            <>
              <button
                ...
                className="px-3.5 py-1.5 rounded-full bg-gradient-to-r from-accentViolet to-accentCyan text-white text-xs font-bold hover:scale-105 transition-transform flex items-center gap-1.5 shadow-md"
              >
